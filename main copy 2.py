...
#     result = extract_filename(file_name)
#     results = find_file(result)
#     if not results:
...
def search_file(file_name: str):
    ...
    # Extract filename/app/search text
    extracted_name = (
        data.get("file_name")
    ...
    # Search file
    results = find_file(extracted_name)
